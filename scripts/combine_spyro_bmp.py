...
directory = "bmps/"
file_list = ["og_s1.bin", "dred.bin", "icy.bin", "rblue.bin", "emerald.bin", "gold.bin", "berry.bin", "zera.bin", "pixie.bin", "jayo.bin", "peri.bin", "woke.bin", "goth.bin", "ditto.bin", "ember.bin", "cyn_cre.bin"]  # Add all your files here

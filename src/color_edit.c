...
extern const unsigned char original_spyro_clut[];
extern int index_array_sizes[7];
extern const int* array_of_section_pixels[7];
...
void InitSpyroClut() {
    deckard_memcpy(original_ps1_clut, (void*)original_spyro_clut, sizeof(original_ps1_clut));
}

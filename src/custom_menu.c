...
VisualizerMenu visualizer_menu = { 0 };
...
extern int g_ghost_menu_reset_confirm_active;
extern int g_ghost_menu_reset_yesno;
...
void CustomMenuUpdate(void)
{
    ...
    if (menu_state == MENU_DISPLAYING && _gameState == GAMESTATE_GAMEPLAY)
    {
        if (current_menu == MAIN_MENU)
        {
            ...
            DrawMenuItem(custom_menu.visualizer_menu_text, 4, custom_menu.selection, 70);
            DrawMenuItem(custom_menu.cosmetic_menu_text, 5, custom_menu.selection, 70);
            ...
            if (custom_menu.il_menu_text == NULL)
            {
                ...
                custom_menu.visualizer_menu_text = "VISUALIZER SETTINGS";
            ...
            {
                custom_menu.selection = (custom_menu.selection + 5) % 6;
            }
        ...
        if (current_menu == IL_MENU)
        {
            ...
            int textbox_bottom = 0x7C;
            #if BUILD == PS2_DECKARD || BUILD == REDUX || BUILD == DUCKSTATION
            textbox_bottom = 0x90;
            #endif

            DrawTextBox(0x30, 0x1D0, 0x34, textbox_bottom);
            ...
            // Update Text + Input
            il_menu.il_mode_text = ToggleMenuBool(&il_menu.il_state, il_menu.selection == 0, "IL MODE ON", "IL MODE OFF");
            il_menu.loop_level_text = ToggleMenuBool(&il_menu.dont_loop_level, il_menu.selection == 1, "LOOP LEVEL OFF", "LOOP LEVEL ON");


            if (il_menu.selection == 2)
            {
        ...
        // Play Sound Effect
            ...
            // Update Displays (bitfields - can't use ToggleMenuBool)
            il_display_modes.il_display_enable_all_text = il_display_modes.il_has_enabled_all ? "DISABLE ALL" : "ENABLE ALL";
            il_display_modes.il_display_dragon_text = il_display_modes.il_display_dragon ? "DISPLAY DRAGON ON" : "DISPLAY DRAGON OFF";
            il_display_modes.il_display_landing_text = il_display_modes.il_display_landing ? "DISPLAY LANDING ON" : "DISPLAY LANDING OFF";
            il_display_modes.il_display_glide_text = il_display_modes.il_display_glide ? "DISPLAY GLIDE ON" : "DISPLAY GLIDE OFF";
            il_display_modes.il_display_flame_text = il_display_modes.il_display_flame ? "DISPLAY FLAME ON" : "DISPLAY FLAME OFF";
            il_display_modes.il_display_gem_text = il_display_modes.il_display_gem ? "DISPLAY GEM COLLECT ON" : "DISPLAY GEM COLLECT OFF";
            il_display_modes.il_display_flight_text = il_display_modes.il_display_flight ? "DISPLAY FLIGHT ITEM ON" : "DISPLAY FLIGHT ITEM OFF";
            il_display_modes.il_display_whirlwind_text = il_display_modes.il_display_whirlwind ? "DISPLAY WHIRLWIND ON" : "DISPLAY WHIRLWIND OFF";
            il_display_modes.il_display_bonk_text = il_display_modes.il_display_bonk ? "DISPLAY BONK ON" : "DISPLAY BONK OFF";
            il_display_modes.il_display_always_text = il_display_modes.il_display_always ? "DISPLAY ALWAYS ON" : "DISPLAY ALWAYS OFF";
            ...
            // Individual display toggles (bitfields - toggle manually)
            if (_currentButtonOneFrame == RIGHT_BUTTON || _currentButtonOneFrame == LEFT_BUTTON)
            {
                switch (il_display_modes.selection)
                {
                    case 1: il_display_modes.il_display_dragon = !il_display_modes.il_display_dragon; break;
                    case 2: il_display_modes.il_display_landing = !il_display_modes.il_display_landing; break;
                    case 3: il_display_modes.il_display_glide = !il_display_modes.il_display_glide; break;
                    case 4: il_display_modes.il_display_flame = !il_display_modes.il_display_flame; break;
                    case 5: il_display_modes.il_display_gem = !il_display_modes.il_display_gem; break;
                    case 6: il_display_modes.il_display_flight = !il_display_modes.il_display_flight; break;
                    case 7: il_display_modes.il_display_whirlwind = !il_display_modes.il_display_whirlwind; break;
                    case 8: il_display_modes.il_display_bonk = !il_display_modes.il_display_bonk; break;
                    case 9: il_display_modes.il_display_always = !il_display_modes.il_display_always; break;
                }
            }
        ...
        if (current_menu == SAVESTATE_MENU)
        {
            ...
            #if BUILD == PS2_DECKARD || BUILD == REDUX || BUILD == DUCKSTATION // DECKARD HAS SAVESTATE SLOT
            {
...
void ResetAllMenuSelections(void)
{
    custom_menu.selection = 0;
    il_menu.selection = 0;
    il_display_modes.selection = 0;
    timer_menu.selection = 0;
    #if BUILD == PS1 || BUILD == PS2_IOP
    savestate_menu.selection = 1;
    #else
    savestate_menu.selection = 0;
    #endif
    misc_menu.selection = 0;
    visualizer_menu.selection = 0;
    time_in_display_menu = 0;
    #if BUILD == REDUX || BUILD == PS2_DECKARD || BUILD == DUCKSTATION
